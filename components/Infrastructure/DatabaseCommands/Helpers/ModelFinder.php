...
class ModelFinder
{
    ...
    public function classes(bool $cached = false): array
    {
        $classes = [];
        foreach ($this->getClassesGenerator() as $class) {
            $classes[] = $class;
        }
    ...
    protected function getClassesGenerator()
    {
        $classes = [];
        foreach ($this->directories as $directory) {
            foreach (App::make(ClassFinder::class)->classesIn($directory) as $class) {
