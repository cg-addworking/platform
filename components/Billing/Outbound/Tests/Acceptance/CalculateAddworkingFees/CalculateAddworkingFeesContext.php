...
class CalculateAddworkingFeesContext extends TestCase implements Context
{
    ...
    /**
     * @Then /^les commissions Addworking de la facture outbound numero "([^"]*)" de l\'entreprise avec le siret "([^"]*)" sont calculées$/
     */
    ...
    /**
     * @Then /^une erreur est levée car l\'entreprise n\'a pas de paramètres de facturation renseignés$/
     */
