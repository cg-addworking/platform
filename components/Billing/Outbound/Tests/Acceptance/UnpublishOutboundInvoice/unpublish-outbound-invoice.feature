...
Fonctionnalité: Unpublish outbound invoice
  Contexte:
...
@depublierUneFactureOutbound
  Scénario: dépublier une facture outbound
    Etant donné que je suis authentifié en tant que utilisateur avec l'email "antoine.pierre@addwun.com"
    Quand j'essaie de dépublier la facture outbound numero "1" 
    Alors la facture outbound numero "1" est depubliee

  Scénario: Impossibilité de dépublier une facture outbound si l'utilisateur connecté n'est pas support
  ...
  Scénario: Impossibilité de dépublier une facture outbound si la facture outbound n'existe pas
    Etant donné que je suis authentifié en tant que utilisateur avec l'email "antoine.pierre@addwun.com"
    Quand j'essaie de dépublier la facture outbound numero "42"
