<?php
namespace Components\Billing\Outbound\Tests\Acceptance\UnpublishOutboundInvoice;
...
class UnpublishOutboundInvoiceContext extends TestCase implements Context
{
    use RefreshDatabase;
    ...
    /**
     * @When /^j\'essaie de dépublier la facture outbound numero "([^"]*)"$/
     */
    public function jessaieDeDepublierLaFactureOutboundNumero(string $number)
    {
        $auth_user = $this->userRepository->connectedUser();
        $outbound_invoice = $this->outboundInvoiceRepository->findByNumber($number);

        try {
            (new UnpublishOutboundInvoice(
                $this->userRepository,
    ...
    /**
     * @Then /^la facture outbound numero "([^"]*)" est depubliee$/
     */
    public function laFactureOutboundNumeroEstDepubliee(string $number)
    {
