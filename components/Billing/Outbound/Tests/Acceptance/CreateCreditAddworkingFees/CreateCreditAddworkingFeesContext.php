...
class CreateCreditAddworkingFeesContext extends TestCase implements Context
{
    ...
    /**
     * @When /^j\'essaie de créer la ligne d\'avoir de la commission numero "([^"]*)" pour la facture outbound numero "([^"]*)"$/
     */
    ...
    /**
     * @Then /^la ligne d\'avoir pour la commission numéro "([^"]*)" est créée$/
     */
