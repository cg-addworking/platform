...
Fonctionnalité: Mark payment order as paid
  ...
  Scénario: Changer le statut de l'ordre de paiement a Payé
    Etant donné que je suis authentifié en tant que utilisateur avec l'email "antoine.pierre@addwun.com"
    Quand j'essaie de mettre le statut payé à l'ordre de paiement numero "1"
    Alors l'ordre de paiement est au status payé

  Scénario: Impossibilité de mettre le statut payé à l'ordre de paiement si l'utilisateur n'est pas support
  ...
  Scénario: Impossibilité de mettre le statut payé à l'ordre de paiement si l'ordre de paiement n'existe pas
    Etant donné que je suis authentifié en tant que utilisateur avec l'email "antoine.pierre@addwun.com"
    Quand j'essaie de mettre le statut payé à l'ordre de paiement numero "5"
    Alors une erreur est levée car l'ordre de paiement n'existe pas

  Scénario: Impossibilité de mettre le statut payé à l'ordre de paiement si l'ordre de paiement n'a pas de fichier
    Etant donné que je suis authentifié en tant que utilisateur avec l'email "antoine.pierre@addwun.com"
    Quand j'essaie de mettre le statut payé à l'ordre de paiement numero "4"
    Alors une erreur est levée car l'ordre de paiement n'a pas de fichier

  Scénario: Impossibilité de mettre le statut payé à l'ordre de paiement si l'ordre de paiement n'est pas au statut en attente
    Etant donné que je suis authentifié en tant que utilisateur avec l'email "antoine.pierre@addwun.com"
    Quand j'essaie de mettre le statut payé à l'ordre de paiement numero "2"
