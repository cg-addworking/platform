<?php
namespace Components\Billing\PaymentOrder\Tests\Acceptance\DeletePaymentOrder;
...
class DeletePaymentOrderContext extends TestCase implements Context
{
    use RefreshDatabase;
    ...
    /**
     * @When /^j\'essaie de supprimer l\'ordre de paiement numero "([^"]*)"$/
     */
    public function jessaieDeSupprimerLordreDePaiementNumero(string $payment_order_number)
    {
        $auth_user = $this->userRepository->connectedUser();
        $payment_order = $this->paymentOrderRepository->findByNumber($payment_order_number);

        try {
            $this->response = (new DeletePaymentOrder(
                $this->userRepository,
    ...
    /**
     * @Then /^l\'ordre de paiement est supprimé$/
     */
    public function lordreDePaiementEstSupprime()
    {
