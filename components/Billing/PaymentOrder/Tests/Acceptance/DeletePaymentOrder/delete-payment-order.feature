#language: fr
 ...
 Fonctionnalité: Delete payment order
   ...
   @supprimerUnOrdreDePaiement
  Scénario: Supprimer un ordre de paiement
    Etant donné que je suis authentifié en tant que utilisateur avec l'email "antoine.pierre@addwun.com"
    Quand j'essaie de supprimer l'ordre de paiement numero "1"
    Alors l'ordre de paiement est supprimé

   Scénario: Impossibilité de supprimer un ordre de paiement si l'utilisateur n'est pas support
   ...
   Scénario: Impossibilité de supprimer un ordre de paiement si l'ordre de paiement n'existe pas
    Etant donné que je suis authentifié en tant que utilisateur avec l'email "antoine.pierre@addwun.com"
    Quand j'essaie de supprimer l'ordre de paiement numero "42"
    Alors une erreur est levée car l'ordre de paiement n'existe pas

   Scénario: Impossibilité de supprimer un ordre de paiement si l'ordre de paiement n'est pas au statut en attente
    Etant donné que je suis authentifié en tant que utilisateur avec l'email "antoine.pierre@addwun.com"
    Quand j'essaie de supprimer l'ordre de paiement numero "2"
