<?php
namespace Components\Billing\PaymentOrder\Tests\Acceptance\DissociateInvoiceFromPaymentOrder;
...
class DissociateInvoiceFromPaymentOrderContext extends TestCase implements Context
{
    use RefreshDatabase;
    ...
    /**
     * @When /^j\'essaie dissocier la facture prestataire numero "([^"]*)" à l\'ordre de paiement numero "([^"]*)"$/
     */
    public function jessaieDissocierLaFacturePrestataireNumeroALordreDePaiementNumero(
        ...
        try {
            $this->response = (new DissociateInvoiceFromPaymentOrder(
                $this->userRepository,
                $this->ibanRepository,
    ...
    /**
     * @Then /^la facture prestataire est dissociée à l\'ordre de paiement$/
     */
    public function laFacturePrestataireEstDissocieeALordreDePaiement()
    {
