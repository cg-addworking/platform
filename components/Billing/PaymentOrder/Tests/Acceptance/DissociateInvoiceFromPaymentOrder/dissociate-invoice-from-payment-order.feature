#language: fr
 ...
 Fonctionnalité: Dissociate invoice from payment order
  ...
  Scénario: Dissocier une facture prestataire à un ordre de paiement
    Etant donné que je suis authentifié en tant que utilisateur avec l'email "antoine.pierre@addwun.com"
    Quand j'essaie dissocier la facture prestataire numero "1" à l'ordre de paiement numero "1"
    Alors la facture prestataire est dissociée à l'ordre de paiement

   Scénario: Impossibilité dissocier une facture prestataire à un ordre de paiement si l'utilisateur n'est pas support
   ...
   Scénario: Impossibilité dissocier une facture prestataire à un ordre de paiement si l'ordre de paiement n'existe pas
    Etant donné que je suis authentifié en tant que utilisateur avec l'email "antoine.pierre@addwun.com"
    Quand j'essaie dissocier la facture prestataire numero "1" à l'ordre de paiement numero "42"
    Alors une erreur est levée car l'ordre de paiement n'existe pas

   Scénario: Impossibilité dissocier une facture prestataire à un ordre de paiement si l'ordre de paiement n'est pas au statut en attente
    Etant donné que je suis authentifié en tant que utilisateur avec l'email "antoine.pierre@addwun.com"
    Quand j'essaie dissocier la facture prestataire numero "1" à l'ordre de paiement numero "2"
