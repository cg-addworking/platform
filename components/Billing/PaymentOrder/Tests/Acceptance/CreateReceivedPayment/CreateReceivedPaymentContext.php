...
class CreateReceivedPaymentContext extends TestCase implements Context
{
    ...
    /**
     * @When /^j\'essaie de créer une notification de fonds reçus pour l\'entreprise avec siret "([^"]*)" avec la facture outbound numero "([^"]*)"$/
     */
    ...
    /**
     * @Then /^la notification de fonds reçus est créée$/
     */
