...
Fonctionnalité: close offer
  ...
  @scenario1
  Scénario: fermée une offre de mission en tant qu'entreprise propriétaire
    Etant donné que je suis authentifié en tant que utilisateur avec l'email "peter.parker@addworking.com"
    Quand j'essaie de fermer l'offre de mission numéro "1"
    Alors l'offre de mission numéro "1" est fermée

  @scenario2
  Scénario: Impossibilité de fermer une offre de mission si elle n'a pas de réponses acceptées
    Etant donné que je suis authentifié en tant que utilisateur avec l'email "natasha.roumanouff@client4.com"
    Quand j'essaie de fermer l'offre de mission numéro "2"
    Alors une erreur est levée car l'offre n'a pas de réponses acceptées

  @scenario3
  Scénario: Impossibilité de fermer une offre de mission si elle est déjà fermée
    Etant donné que je suis authentifié en tant que utilisateur avec l'email "clark.kent@client3.com"
    Quand j'essaie de fermer l'offre de mission numéro "3"
    Alors une erreur est levée car l'offre est déjà fermée

  @scenario4
  Scénario: Impossibilité de fermer une offre de mission en tant qu'utilisateur si l'entreprise n'est pas propriétaire
    Etant donné que je suis authentifié en tant que utilisateur avec l'email "clark.kent@client3.com"
    Quand j'essaie de fermer l'offre de mission numéro "1"
