#language: fr
Fonctionnalité: show construction response
  Contexte:
  ...
  @scenario1
  Scénario: Voir le détail d'une réponse en tant que support
    Etant donné que je suis authentifié en tant que utilisateur avec l'email "peter.parker@addworking.com"
    Quand j'essaie de voir le détail de la réponse numéro "4" de l'offre numéro "2"
    Alors le détail de la réponse numéro "4" est affiché

  @scenario2
  Scénario: Voir le détail d'une réponse en tant que membre d'une entreprise propriétaire de l'offre
    Etant donné que je suis authentifié en tant que utilisateur avec l'email "clark.kent@client3.com"
    Quand j'essaie de voir le détail de la réponse numéro "5" de l'offre numéro "3"
    Alors le détail de la réponse numéro "5" est affiché

  @scenario3
  Scénario: Voir le détail d'une réponse en tant que membre d'une entreprise propriétaire de la réponse
    Etant donné que je suis authentifié en tant que utilisateur avec l'email "jean.paul@clideux.com"
    Quand j'essaie de voir le détail de la réponse numéro "4" de l'offre numéro "2"
    Alors le détail de la réponse numéro "4" est affiché

  @scenario4
  Scénario: Impossibilité de voir le détail d'une réponse si elle n'existe pas
    Etant donné que je suis authentifié en tant que utilisateur avec l'email "natasha.roumanouff@client4.com"
    Quand j'essaie de voir le détail de la réponse numéro "15" de l'offre numéro "1"
    Alors une erreur est levée car la réponse n'existe pas

  @scenario5
  Scénario: Impossibilité de voir le détail d'une réponse en tant que membre d'une entreprise si l'entreprise n'est pas propriétaire de l'offre
    Etant donné que je suis authentifié en tant que utilisateur avec l'email "clark.kent@client3.com"
    Quand j'essaie de voir le détail de la réponse numéro "1" de l'offre numéro "1"
    Alors une erreur est levée car l'entreprise n'est pas propriétaire de l'offre
  
  @scenario6
  Scénario: Impossibilité de voir le détail d'une réponse en tant que membre d'une entreprise si l'entreprise n'est pas propriétaire de la réponse
    Etant donné que je suis authentifié en tant que utilisateur avec l'email "clark.kent@client3.com"
    Quand j'essaie de voir le détail de la réponse numéro "1" de l'offre numéro "2"
    Alors une erreur est levée car l'entreprise n'est pas propriétaire de la réponse