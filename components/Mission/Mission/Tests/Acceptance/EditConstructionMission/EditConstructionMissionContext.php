...
class EditConstructionMissionContext extends TestCase implements Context
{
    ...
    /**
     * @When j'essaie de modifier la mission numéro :arg1
     */
    ...
    /**
     * @Then la mission numéro :arg1 est modifiée
     */
    ...
    /**
     * @Then une erreur est levée car la mission n'est pas en brouillon ou bon pour démarrage
    */
