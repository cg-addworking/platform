#language: fr
Fonctionnalité: List Invoice Parameters
  ...
  Scénario: Lister les parametres de facturation d'une entreprise en tant que support
    Etant donné que je suis authentifié en tant que utilisateur avec l'email "antoine.pierre@addwun.com"
    Quand j'essaie de lister les parametres de facturation de l'entreprise avec le siret "02000000000000"
    Alors les parametres de facturation sont listées

  Scénario: Impossibilité de lister les parametres de facturation si l'utilisateur connecté n'est pas support
