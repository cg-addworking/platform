...
class ShowWorkFieldContext extends TestCase implements Context
{
    ...
    /**
     * @When /^j\'essaie de voir le détail du chantier numéro "([^"]*)"$/
     */
    ...
    /**
     * @Then /^le détail du chantier numéro "([^"]*)" est affiché$/
     */
    ...
    /**
     * @Then /^une erreur est levée car l\'utilisateur n\'a pas de relation avec le chantier$/
     */
    ...
    /**
     * @Then /^une erreur est levée car le chantier n\'existe pas$/
     */
