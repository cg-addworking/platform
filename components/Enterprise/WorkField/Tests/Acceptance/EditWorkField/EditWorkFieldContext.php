...
class EditWorkFieldContext extends TestCase implements Context
{
    ...
    /**
     * @When /^j\'essaie de modifier le chantier numéro "([^"]*)"$/
     */
    public function jessaieDeModifierLeChantierNumero(string $work_field_number)
    {
        ...
        $data = [
            'display_name' => 'Chantier modifiée',
    ...
    /**
     * @Then /^le chantier numéro "([^"]*)" est modifié$/
     */
    ...
    /**
     * @Then /^une erreur est levée car l\'utilisateur n\'a pas le rôle de propriétaire\/administrateur$/
     */
