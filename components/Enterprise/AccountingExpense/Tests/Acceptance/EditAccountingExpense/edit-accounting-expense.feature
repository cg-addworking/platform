#language: fr
Fonctionnalité: modidier un poste de dépense
  Contexte:
  ...
  @scenario1
  Scénario: Modifier un poste de dépense en tant que support
    Étant donné que je suis authentifié en tant que utilisateur avec l'émail "john.smith@addworking.com"
    Quand j'essaie de modifier le poste de dépense numéro "1" pour l'entreprise avec le siret numéro "02000000000000"
    Alors le poste de dépense est modifié

  @scenario2
  Scénario: Modifier un poste de dépense en tant que membre de l'entreprise avec le rôle financier
    Étant donné que je suis authentifié en tant que utilisateur avec l'émail "stan.lee@marvel-studios.com"
    Quand j'essaie de modifier le poste de dépense numéro "1" pour l'entreprise avec le siret numéro "02000000000000"
    Alors le poste de dépense est modifié

  @scenario3
  Scénario: Impossibilité de modifier un poste de dépense en tant que membre de l'entreprise sans le rôle financier
  ...
  @scenario4
  Scénario: Impossibilité de modifier un poste de dépense si je ne suis pas membre de l'entreprise
    Étant donné que je suis authentifié en tant que utilisateur avec l'émail "stan.lee@marvel-studios.com"
    Quand j'essaie de modifier le poste de dépense numéro "2" pour l'entreprise avec le siret numéro "03000000000000"
