...
class UnpublishDocumentTypeModelContext extends TestCase implements Context
{
    ...
    /**
     * @When /^j\'essaie de dépublier le document type model numéro "([^"]*)"$/
     */
    ...
    /**
     * @Then /^le document type model numéro "([^"]*)" est dépublié$/
     */
    ...
    /**
     * @Then /^une erreur est levée car le document type model n\'est pas publié$/
     */
