@extends('foundation::layout.app.create', ['action' => route('contract.part.store.signed.contract.part', $contract), 'enctype' => "multipart/form-data"])
...
@section('form')
    @include('contract::contract_part.signed_contract._form')
