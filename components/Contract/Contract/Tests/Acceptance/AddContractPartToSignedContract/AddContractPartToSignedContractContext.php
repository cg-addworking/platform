...
namespace Components\Contract\Contract\Tests\Acceptance\AddContractPartToSignedContract;
...
use Components\Contract\Contract\Domain\Exceptions\ContractIsAlreadySignedException;
...
class AddContractPartToSignedContractContext extends TestCase implements Context
{
    use RefreshDatabase;
    ...
    public function jessaieDajouterUnePieceDeContratAuContratNumero(string $contract_number)
    {
        ...
        $inputs = ['display_name' => "Annexe"];
        $file = factory(File::class)->create();

        try {
            $this->response = (new AddContractPartToSignedContract(
    ...
    /**
     * @Then /^une erreur est levée car le contrat n\'a pas encore été généré$/
     */
    public function uneErreurEstLeveeCarLeContratNaPasEncoreEteGenere()
    {
        $this->assertContainsEquals(
    ...
    /**
     * @Then /^une erreur est levée car le contrat n\'a pas encore été signé$/
     */
    public function uneErreurEstLeveeCarLeContratNaPasEncoreEteSigne()
    {
        $this->assertContainsEquals(
            ContractInvalidStateException::class,
            $this->errors
    ...
    /**
     * @Then /^une erreur est levée car le contrat est déjà signée par au moins une partie prenante$/
     */
    public function uneErreurEstLeveeCarLeContratEstDejaSigneeParAuMoinsUnePartiePrenante()
    {
        $this->assertContainsEquals(
            ContractInvalidStateException::class,
            $this->errors
    ...
    /**
     * @Then /^une erreur est levée car l\'utilisateur authentifié n\'est pas propriétaire du contrat ou partie prenante$/
     */
    public function uneErreurEstLeveeCarLutilisateurAuthentifieNestPasProprietaireDuContratOuPartiePrenante()
    {
        $this->assertContainsEquals(
