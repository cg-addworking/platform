...
Fonctionnalité: create contract
  ...
  @scenario1
  Scénario: Créer un contrat pour une entreprise qui possède le modèle de contrat
    Etant donné que je suis authentifié en tant que utilisateur avec l'émail "antoine.pierre@addwun.com"
    Quand j'essaie de créer un contrat à partir du modèle de contrat numéro "1" pour l'entreprise avec le siret "03000000000000"
    Alors le contrat est crée

  @scenario2
  Scénario: Créer un contrat pour une entreprise qui est filiale d'une entreprise qui possède le modèle de contrat
    Etant donné que je suis authentifié en tant que utilisateur avec l'émail "antoine.pierre@addwun.com"
    Quand j'essaie de créer un contrat à partir du modèle de contrat numéro "3" pour l'entreprise avec le siret "03000000000000"
    Alors le contrat est crée

  @scenario3
  Scénario: Créer un contrat pour une entreprise avec un modèle de contrat sans rapport
    Etant donné que je suis authentifié en tant que utilisateur avec l'émail "antoine.pierre@addwun.com"
    Quand j'essaie de créer un contrat à partir du modèle de contrat numéro "4" pour l'entreprise avec le siret "03000000000000"
    Alors une erreur est levée car le modèle de contrat n'a pas de rapport avec l'entreprise en question

  @scenario4
  Scénario: Impossibilité de créer un contrat si le modèle de contrat n'est pas publié
    Etant donné que je suis authentifié en tant que utilisateur avec l'émail "antoine.pierre@addwun.com"
    Quand j'essaie de créer un contrat à partir du modèle de contrat numéro "2" pour l'entreprise avec le siret "03000000000000"
