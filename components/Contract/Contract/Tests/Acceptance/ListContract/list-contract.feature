...
Fonctionnalité: list contract
  ...
  @scenario1
  Scénario: Lister les contrats
    Etant donné que je suis authentifié en tant que utilisateur avec l'email "victor.hugo@miserables.com"
    Quand j'essaie de lister tous les contrats de mes entreprises
    Alors tous les contrats de mes entreprises sont listés
