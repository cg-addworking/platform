...
namespace Components\Contract\Contract\Tests\Acceptance\ListContract;
...
class ListContractContext extends TestCase implements Context
{
    use RefreshDatabase;
    ...
    /**
     * @When /^j\'essaie de lister tous les contrats de mes entreprises$/
     */
    public function jessaieDeListerTousLesContratsDeMesEntreprises()
    {
        $auth_user = $this->userRepository->connectedUser();

        try {
            $this->response = (new ListContract(
                $this->userRepository,
    ...
    /**
     * @Then /^tous les contrats de mes entreprises sont listés$/
     */
    public function tousLesContratsDeMesEntreprisesSontListes()
    {
