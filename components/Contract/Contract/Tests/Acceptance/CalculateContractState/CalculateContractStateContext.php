...
class CalculateContractStateContext extends TestCase implements Context
{
    ...
    private $states = [
        ...
        "en préparation" => Contract::STATE_IN_PREPARATION,
        "documents à fournir" => Contract::STATE_MISSING_DOCUMENTS,
    ...
    /**
     * @Given /^ces variables sont tous renseignées$/
     */
    ...
    /**
     * @Given /^ces variables ne sont pas tous renseignées$/
     */
    ...
    /**
     * @Given /^le contrat n\'a pas de pièce non volante$/
     */
    ...
    /**
     * @Given /^le contrat a au moins une pièce non volante$/
     */
    ...
    /**
     * @Given /^les parties prenantes ont des dates de signatures renseignées\.$/
     */
    ...
    /**
     * @Given /^la date de début du contrat est supérieur ou égale à la date du jour$/
     */
    ...
    /**
     * @Given /^la date du jour est supérieur ou égale à la date de début du contrat$/
     */
    ...
    /**
     * @Given /^la date du jour est supérieure ou égale à la date de fin du contrat$/
     */
