#language: fr
Fonctionnalité: create contract model part
  Contexte:
  ...
  @scenario1
  Scénario: Créer une pièce pour un modèle de contrat
    Etant donné que je suis authentifié en tant que utilisateur avec l'email "antoine.pierre@addwun.com"
    Quand j'essaie de créer une pièce pour le modèle de contrat numéro "1"
    Alors Le modèle de contrat numéro "1" possède une pièce, et quatre variables

  @scenario2
  Scénario: Impossibilité de créer une pièce pour un modèle de contrat si l'utilisateur n'est pas support
  ...
  @scenario3
  Scénario: Impossibilité de créer une pièce pour un modèle de contrat s'il est publié
    Etant donné que je suis authentifié en tant que utilisateur avec l'email "antoine.pierre@addwun.com"
    Quand j'essaie de créer une pièce pour le modèle de contrat numéro "2"
    Alors une erreur est levée car le modèle de contrat est publié

  @scenario4
  Scénario: Impossibilité de créer une pièce pour un modèle de contrat s'il est archivé
    Etant donné que je suis authentifié en tant que utilisateur avec l'email "antoine.pierre@addwun.com"
    Quand j'essaie de créer une pièce pour le modèle de contrat numéro "3"
