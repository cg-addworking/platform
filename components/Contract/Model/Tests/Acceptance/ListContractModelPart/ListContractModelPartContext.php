...
namespace Components\Contract\Model\Tests\Acceptance\ListContractModelPart;
...
class ListContractModelPartContext extends TestCase implements Context
{
    use RefreshDatabase;
    ...
    /**
     * @When /^j\'essaie de lister toute les pieces du model de contract numero "([^"]*)"$/
     */
    public function jessaieDeListerTouteLesPiecesDuModelDeContractNumero($contract_model_number)
    {
        ...
        try {
            $this->response = (new ListContractModelPart(
    ...
    /**
     * @Then /^toute les pieces du modeles de contrats numero "([^"]*)" sont listes$/
     */
    public function touteLesPiecesDuModelesDeContratsNumeroSontListes($arg1)
    {
        $this->assertDatabaseCount('addworking_contract_contract_model_parts', 4);
