...
Fonctionnalité: list contract model variables
  ...
  @scenario1
  Scénario: Lister les variables du modèle de contrat
    Etant donné que je suis authentifié en tant que utilisateur avec l'email "antoine.pierre@addwun.com"
    Quand j'essaie de lister toutes les variables du modèle de contrat numéro "1"
    Alors toutes les variables du modèle de contrat numéro "1" sont listées

  @scenario2
  Scénario: Impossibilité de lister les variables du modèle de contrat si l'utilisateur n'est pas support
