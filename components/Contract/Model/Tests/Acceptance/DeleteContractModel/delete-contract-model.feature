#language: fr
Fonctionnalité: delete drafted contract model
  Contexte:
  ...
  @scenario1
  Scénario: supprimer un modèle de contrat en mode draft
    Etant donné que je suis authentifié en tant que utilisateur avec l'email "antoine.pierre@addwun.com"
    Quand j'essaie de supprimer le modèle de contrat numéro "1"
    Alors le modèle de contrat numéro "1" est supprimé

  @scenario2
  Scénario: Impossibilité de supprimer un modèle de contrat en mode draft si l'utilisateur n'est pas support
  ...
  Scénario: Impossibilité de supprimer un modèle de contrat s'il est publié
    Etant donné que je suis authentifié en tant que utilisateur avec l'email "antoine.pierre@addwun.com"
    Quand j'essaie de supprimer le modèle de contrat numéro "2"
  ...
  Scénario: Impossibilité de supprimer un modèle de contrat s'il est archivé
    Etant donné que je suis authentifié en tant que utilisateur avec l'email "antoine.pierre@addwun.com"
    Quand j'essaie de supprimer le modèle de contrat numéro "3"
