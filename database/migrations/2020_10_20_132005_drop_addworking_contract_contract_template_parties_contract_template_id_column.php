...
class DropAddworkingContractContractTemplatePartiesContractTemplateIdColumn extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        ...
        if($driver !== 'sqlite') {
            Schema::table('addworking_contract_contract_template_parties', function (Blueprint $table) {
