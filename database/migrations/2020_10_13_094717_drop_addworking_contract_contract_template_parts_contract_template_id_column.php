...
class DropAddworkingContractContractTemplatePartsContractTemplateIdColumn extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        ...
        if($driver !== 'sqlite') {
            Schema::table('addworking_contract_contract_template_parts', function (Blueprint $table) {
