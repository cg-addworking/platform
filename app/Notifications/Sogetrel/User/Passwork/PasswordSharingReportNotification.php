...
class PasswordSharingReportNotification extends Notification implements ShouldQueue
{
    use Queueable;
    ...
    public function toMail($notifiable)
    {
        return (new MailMessage)
            ->subject('Plateforme Sogetrel AddWorking - Profil qui a été partagé !')
            ->markdown('emails.sogetrel.user.passwork.shared', $this->toArray());
    }
