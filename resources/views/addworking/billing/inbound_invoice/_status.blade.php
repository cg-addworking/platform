@switch ($inbound_invoice->status)
    ...
    @case (inbound_invoice()::STATUS_PAID)
        <span class="badge badge-pill badge-success" style="color: #28a745; border: 1px solid #28a745; background-color: transparent;">{{ __('addworking.billing.inbound_invoice._status.paid') }}</span>
        @break
    @default
