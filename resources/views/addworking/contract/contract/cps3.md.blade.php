    ...
    <tr>
        <td width="45%" height="250px" valign="top">
            <p>
                ...
                @endif
                représentée par {{ $contract->customer->legalRepresentatives->first()->name }}
        ...
        <td width="45%" height="250px" valign="top">
            <p>
                ...
                @endif
                représentée par {{ $contract->vendor->legalRepresentatives->first()->name }}
            ...
            <p>Activité du Client : {{ $contract->vendor->activity->activity }}</p>
...
**Identification des prestations fournies par le Prestataire au Client** : Prestation de transport de marchandises.

**Nature du Contrat** :

*Le présent contrat est conclu pour une durée indéterminée.*

**Prix des prestations - Volume des prestations - Transmission des Ordres de Missions** :

*Selon le contrat en vigueur signé entre le Client {{ $contract->customer->name }} et le Prestataire {{ $contract->vendor->name }}.*

**Assurances** :

*Il est rappelé que pour l’exercice de ses prestations, le Prestataire doit avoir sa propre assurance. Le Prestataire devra fournir l’attestation de sa couverture sur son interface Prestataire du site ADDWORKING.*

**Conditions de paiement** :

*Délais de paiement du Client à ADDWORKING : 30 jours à réception de facture*

*Délais de paiement de ADDWORKING au Prestataire : 5 jours à réception du règlement par le Client*


**Gestion des Frais** : *Sans objet*
...
<table width="100%" cellspacing="15">
    <tr>
        <td width="50%" height="10px" valign="bottom">
            Pour le Prestataire :
...
<div style="height: 46px; page-break-before: always;">
    <center>
        @unless (config('app.env') == 'local')
            <img src="{{ asset('img/logo_addworking_vertical.png') }}" alt="Addworking Logo" width="15%">
        @endunless
...
<div style="height: 46px; page-break-before: always">
    @unless (config('app.env') == 'local')
        <center><img src="{{ asset('img/logo_addworking_vertical.png') }}" alt="Addworking Logo" width="15%"></center>
    @endunless
</div>
