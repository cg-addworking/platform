...
{{ __('emails.addworking.mission.offer.accept_offer.response_to_mission_proposal') }} {{ $offer->label }} {{ __('emails.addworking.mission.offer.accept_offer.validate') }} {{ $offer->customer->name }}.
