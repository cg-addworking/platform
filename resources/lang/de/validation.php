...
return [
    ...
    "attributes" => [
        "enterprise.identification_number" => "Französische Handelsregisternummer Nummer (14 Zeichen)",
        "enterprise.name" => "Firmenbezeichnung",
        "enterprise.tax_identification_number" => "Innergemeinschaftlich Umsatzsteuer-Identifikationsnummer",
        "passwork" => [
